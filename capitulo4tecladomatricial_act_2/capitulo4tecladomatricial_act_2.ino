...
//Modificá la distribución de teclas, convitiendolas en palabras:
//1- Esto
//2- es
//3- una
//4- para
...
char clave[13]; //se almacena la clave ingresada
char claveCorrecta[13] = "Esto es una para aquellos que sigan practicando con nuestro curso BOTS "; //se almacena la clave que es correcta
