...
//Modificá el código para ingresar claves de 8 dígitos
...
char clave[9]; //se almacena la clave ingresada
char claveCorrecta[9] = "03072002"; //se almacena la clave que es correcta
...
void loop() {
  ...
  if (indice == 8){  //si ya se completaron los 4 dígitos....
